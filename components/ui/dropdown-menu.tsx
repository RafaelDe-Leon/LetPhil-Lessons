...
// Check if the DropdownMenuPrimitive.Portal is being used correctly
// Make sure the component is properly exporting all necessary parts

// Ensure the DropdownMenuContent has proper z-index and positioning
