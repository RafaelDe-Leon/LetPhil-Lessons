...
export const metadata: Metadata = {
  title: "LetPhil - Community Learning Hub",
  description: "Access recorded coaching sessions from the LetPhil community",
    generator: 'v0.dev'
}
                ...
                <div className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                  <div className="flex h-16 items-center justify-between">
                    <Link href="/" className="flex items-center gap-2" prefetch={true}>
                      ...
                      <span className="text-xl font-bold bg-gradient-to-r from-slate-700 to-slate-900 bg-clip-text text-transparent dark:from-slate-100 dark:to-slate-300 hidden sm:block">
                        LetPhil - Learning Hub
                      </span>
                      <span className="text-lg font-bold bg-gradient-to-r from-slate-700 to-slate-900 bg-clip-text text-transparent dark:from-slate-100 dark:to-slate-300 sm:hidden">
                        LetPhil
                      </span>
                    </Link>
                    <Navigation />
                ...
                <div className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                  <div className="flex flex-col items-center justify-between gap-4 md:h-16 md:flex-row">
                    <p className="text-sm text-slate-500 dark:text-slate-400 text-center md:text-left">
                      © {new Date().getFullYear()} LetPhil Community. All rights reserved.
                    </p>
                  </div>
                </div>
              </footer>
